...
import Items from "../../json/ProgItem.json";
function ProgCard({ title }) {
  return (
    <div className="border-solid border-2 border-orange-500 rounded-lg shadow-md p-5">
      ...
      <div className="flex flex-wrap gap-5 justify-between items-center md:flex md:flex-wrap md:gap-1 md:w-[600px] md:mt-5 lg:w-[400px]">
