...
function Education() {
  return (
    <section>
      ...
      <div className=" flex flex-row flex-wrap justify-between mx-auto max-w-screen-xl my-10">
        ...
        <div className=" para w-1/2 pl-5 text-orange-600 font-bold text-2xl">
          <h1>Oct 2021 - June 2024</h1>
        </div>
      </div>
      <div className=" flex flex-row-reverse flex-wrap justify-between mx-auto max-w-screen-xl my-10">
        <div className="w-1/2 border-solid border-2 shadow-lg rounded-md p-2">
          <div className="flex bg-gray-300 rounded-md">
            <div className="1/4">
        ...
        <div className=" para w-1/2 text-end pr-5 text-orange-600 font-bold text-2xl">
          <h1>Aug 2018 - Oct 2021</h1>
        </div>
      </div>
      <div className=" flex lex-row flex-wrap justify-between mx-auto max-w-screen-xl my-10">
        <div className="w-1/2 border-solid border-2 shadow-lg rounded-md p-2">
          <div className="flex bg-gray-300 rounded-md">
            <div className="1/4">
      ...
      <div className=" flex flex-row-reverse flex-wrap justify-between mx-auto max-w-screen-xl my-10">
        ...
        <div className="w-1/2 text-end pr-5 text-orange-600 font-bold text-2xl">
